...
import {
  CreateTechnologyDocs,
  CreateTechnologyResponseDocs,
  DeleteTechnologyResponseDocs,
  UpdateTechnologyDocs,
} from './docs';
...
export class TechnologiesController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Successful to get all technologies',
    type: [TechnologyDocs],
  })
  getAll() {
  ...
  @ApiResponse({
    status: 201,
    description: 'Successful to create technology',
    type: CreateTechnologyResponseDocs,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Successful to get technology',
    type: TechnologyDocs,
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Successful to update technology',
    type: TechnologyDocs,
  })
  update(
  ...
  @ApiResponse({
    status: 200,
    description: 'Successful to delete technology',
    type: DeleteTechnologyResponseDocs,
  })
