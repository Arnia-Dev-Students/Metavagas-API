    ...
    it('should be defined', () => {
      ...
      describe('update', () => {
        it('should return a updated user', async () => {
          const updatedUser = await service.update(1, userMock, 1, UserRoleEnum.ADMIN);
      ...
      describe('delete', () => {
        it('should return a success message', async () => {
          const deletedUserResponse = await service.delete(1, 1, UserRoleEnum.ADMIN);
    
          expect(deletedUserResponse).toEqual({ response: 'User deleted with success.' });
        });
      });
